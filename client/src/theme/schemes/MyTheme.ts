...
const themeColors = {
  primary: "#3498db", // Blue
  secondary: "#2c3e50", // Green
  // secondary: "#2ecc71", // Green
  success: "#27ae60", // Emerald
  warning: "#f39c12", // Orange
  error: "#e74c3c", // Red
  info: "#3498db", // Blue (you can change this if needed)
  black: "#2c3e50", // Dark Grayish Blue
  white: "#ffffff", // Light Gray
  primaryAlt: "#34495e", // Dark Blue Gray
  purple: "#9b59b6", // Purple (main color)
};
    ...
    MuiBackdrop: {
      styleOverrides: {
        root: {
          ...
          backdropFilter: "blur(0px)",//2px 28012024

          "&.MuiBackdrop-invisible": {
            backgroundColor: "transparent",
            backdropFilter: "blur(0px)", //2px
          },
        },
      },
    },
