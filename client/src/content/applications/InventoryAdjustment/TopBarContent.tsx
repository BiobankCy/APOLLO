    ...
    <>
      <RootWrapper>
        <Box display="flex" alignItems="center">
          ...
          />
          <Box ml={1}>
            <Typography variant="h4">Inventory Adjustment</Typography>
            <Typography variant="subtitle1">
              {/*{formatDistance(subMinutes(new Date(), 8), new Date(), {*/}
              {/*  addSuffix: true*/}
              {/*})}*/}
              Adjust inventory quantities accurately for improved stock
              management.
            </Typography>
          </Box>
        </Box>
        ...
        >
          <Tooltip placement="bottom" title="Clear Count List">
