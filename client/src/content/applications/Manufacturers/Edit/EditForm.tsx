...
import { updateSingleManufacturer } from "src/services/user.service";
...
const EditForm: FC<MyProps> = ({ FormValuesProps }) => {
  ...
  let supplierToSubmitFinal = FormValuesProps.initmanufacturer;
  ...
  const onSubmit1 = () => {
    updateSingleManufacturer(supplierToSubmitFinal)
      .then((response) => {
        if (response.status === 200) {
          showAlert("Manufacturer Successfully Updated!", "success");
  ...
  useEffect(() => {
    if (FormValuesProps.initmanufacturer) {
      ...
      // setFaxNumber(FormValuesProps.initmanufacturer.faxnumber.toString());
    ...
    FormValuesProps.initmanufacturer && (
      <Card>
        <CardHeader
          ...
          subheader={"Code: ".concat(FormValuesProps.initmanufacturer?.code || "")}
          ...
          >
            <div>
              ...
              <TextField
                ...
                label="Created Date"
                type="datetime-local"
                defaultValue={FormValuesProps.initmanufacturer.createdDate}
                sx={{ width: 200 }}
                InputLabelProps={{
                  shrink: true,
                }}
